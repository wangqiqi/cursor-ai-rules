...
自动扫描 `.cursor/features/skills/` 目录，读取 `registry.json`，发现所有可用技能。
...
✓ 加载技能: .cursor/features/skills/api-design.md
...
Skill Dispatcher 读取 `.cursor/features/skills/registry.json` 来获取技能元数据。
...
- `.cursor/features/skills/registry.json` - 技能注册表
