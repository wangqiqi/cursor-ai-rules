...
**🌟 企业级AI编程协作平台 - 23个规则 + 24个技能 + 340个能力映射 + 17个自动化钩子 + 6个VIBE服务**

📚 **[快速开始](docs/guides/quick-start.md)** | **[智能代理指南](docs/guides/intelligent-evolution-guide.md)** | **[Token优化指南](docs/guides/token-compression-guide.md)** | **[MCP集成指南](docs/skills/mcp-priority-system.md)** | **[VIBE开发指南](rules/workflow/vibe-coding.md)**
...
**📖 [详细架构说明](docs/architecture/project-growth-architecture.md)**
...
| 🎯 **340个能力映射**    | 全面的意图到行动映射系统，支持验证和降级策略   | **智能编排**           |
...
#### **AI核心数据 (ai/)**
- **代理状态**: 8个AI代理（Planner, Generator, Tester, Deployer等）的实时状态和配置
...
*🌱 核心创新*: 23个规则、24个技能、340个能力映射、17个自动化钩子，从静态工具到动态生长实体，从单次交互到持续学习，从通用AI到个性化助手，现在具备多代理协作和MCP生态集成！
