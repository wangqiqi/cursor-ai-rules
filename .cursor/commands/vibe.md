---
command: vibe
description: "🚀 VIBE Coding 开发总指挥 - 文档驱动、测试先行、前后端对齐的智能开发模式"
alwaysApply: true
---

# 🚀 VIBE Coding 智能开发总指挥 (VIBE Coding Intelligent Development Commander)

*版本: v4.3.0 | 最后更新: 2026-01-17 | 作者: wangqiqi (https://github.com/wangqiqi)*

## 🧠 核心理念：文档驱动 + 测试先行 + 前后端对齐 + 智能化开发

**🚀 升级完成：真正的开发方法论革命**
- ✅ **6大VIBE服务**：100%覆盖开发全生命周期
- ✅ **4阶段开发流程**：文档→开发→测试→对齐的完整闭环
- ✅ **智能对齐验证**：自动检测前后端、文档代码一致性
- ✅ **测试驱动保障**：从需求到部署的质量全方位把控

**颠覆传统开发模式**：不再是自由散漫的开发方式，VIBE提供文档驱动、测试先行、前后端对齐的标准化开发流程，通过智能化服务确保开发质量和效率。
...
- 📚 **文档驱动**: 任何开发活动从完整文档开始
- 🏗️ **分层开发**: 前端优先，后端跟随，从外到内
- 🧪 **测试先行**: 测试计划先于代码实现
- 🔗 **接口对齐**: 前后端契约化开发，多次对齐验证
- 🎯 **智能化**: 6大服务自动编排开发流程
- 📊 **质量保障**: 自动化对齐检查和质量门禁
...
```bash
# 🎉 一键启动VIBE开发模式！只需描述项目需求，AI自动编排完整开发流程
@vibe start 开发一个任务管理应用，支持团队协作和进度跟踪
@vibe prd 基于VIBE原则设计电商平台产品需求文档
@vibe code 按照VIBE流程生成用户登录模块的完整代码
@vibe test 为购物车功能生成完整的测试用例
@vibe deploy 配置生产环境的自动化部署流程

# 🚀 VIBE全生命周期智能管理
@vibe 初始化项目         # 基于VIBE原则的项目脚手架
@vibe 需求分析           # 深度需求分析和文档化
@vibe 前端开发           # 前端优先分层开发
@vibe 后端开发           # 后端跟随开发
@vibe 接口对齐           # 前后端接口对齐验证
@vibe 测试驱动           # 完整测试流程管理
@vibe 对齐检查           # 文档代码前后端对齐验证
@vibe 部署上线           # 质量保障的部署流程
```

### 🔄 VIBE统一开发架构

**系统集成**: `@vibe-coding` + `@vibe-services-integration.sh` + `vibe-alignment-checker.sh`

**🎉 完整VIBE支持**: `@vibe` 现在通过调用6大VIBE服务和对齐验证工具实现完整的开发流程管理！不仅提供开发指导，还会自动验证对齐质量，实现真正的开发质量保障。

```mermaid
graph TD
    A[用户需求] --> B[VIBE意图分析]
    B --> C[@vibe-coding 开发原则]
    C --> D[6大VIBE服务编排]
    D --> E[文档 + 前端 + 后端 + 测试 + 对齐]
    E --> F[质量门禁验证]
    F --> G[结果反馈 + 学习优化]
...
系统会自动分析：
- **项目意图**: 新建项目、功能开发、系统重构等
- **技术栈**: 前端框架、后端技术、数据库选择等
- **开发阶段**: 需求分析、前端开发、后端开发、测试阶段等
- **质量要求**: 企业级、创业级、个人项目的不同标准
- **团队规模**: 个人开发、小团队、大型团队的不同流程

### 🎯 VIBE开发场景支持

#### 🚀 项目创建系列
```bash
@vibe start 创建React电商平台      # 完整VIBE项目脚手架
@vibe start 创建Vue.js管理系统     # Vue全栈应用模板
@vibe start 创建Node.js微服务      # 微服务架构项目
@vibe start 创建全栈博客系统       # 前后端一体化应用
@vibe start 创建移动端App后端      # API服务开发模板
```
...
*核心创新*: 从传统开发到文档驱动，从分离开发到前后端对齐，从被动测试到主动质量保障！

**立即开始你的VIBE开发之旅**: `@vibe start 你的项目需求描述`