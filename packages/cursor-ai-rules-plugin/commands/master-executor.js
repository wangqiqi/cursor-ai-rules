    ...
    generateLearningResources(technology) {
        const resources = {
            general: {
                ...
                rules: [
                    { name: 'constitution', description: 'AI共生宪法', path: '.cursor/docs/reference/specifications/constitution.md' },
                    { name: 'vibe-coding', description: 'VIBE开发原则', path: '.cursor/rules/workflow/vibe-coding.md' },
                    { name: 'javascript', description: 'JavaScript开发规则', path: '.cursor/rules/tech/javascript.md' }
                ]
            },
            javascript: {
                documentation: [
                    { title: 'JavaScript开发规则', path: '.cursor/rules/tech/javascript.md', type: 'markdown' },
    ...
    getRecommendedLearningPath(technology) {
        const paths = {
            ...
            javascript: [
                ...
                '2. 了解Node.js运行时和模块系统',
                '3. 学习.cursor/rules/tech/javascript.md规则',
