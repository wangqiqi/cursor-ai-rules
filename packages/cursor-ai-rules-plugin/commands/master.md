...
### 🎭 角色系统特色
- **21种独特人格**: 从专业助手到动漫风格角色的完整选择
- **昵称呼叫系统**: 支持亲切的中文昵称，让交互更自然
- **情绪匹配**: 根据当前心情选择合适的AI伙伴
- **文化适应**: 支持中文文化语境的角色互动
...
### 🎭 AI人格系统
- **21种人格角色**: 8种专业角色 + 13种动漫风格角色
- **昵称系统**: 支持多昵称个性化定制
- **交互风格**: 从正式专业到活泼可爱的丰富选择
- **文化适应**: 专为中文开发者优化的角色体验
...
### 角色互动
```
/master 呼叫 小妮                    # 切换到可爱萝莉模式
/master 切换角色 queen_sister        # 切换到御姐女王
/master 给完美女仆设置昵称 小可        # 个性化昵称设置
```
→ 系统会切换到指定角色，提供独特的交互体验和语言风格
...
- `/master 呼叫 小妮`                    // 亲切呼叫可爱萝莉
- `/master 切换角色 cyberpunk_hacker`   // 切换到赛博朋克黑客
- `/master 给魔法少女程序员添加昵称 小魔` // 个性化昵称设置
